...
// Cursor hover effect on links, buttons, and cards
const hoverElements = document.querySelectorAll('a, button, .tech-icon, .skill-category, .service-card, .project-card, .filter-btn');
...
// ====================================
// Enhanced DevOps Knowledge Base
// ====================================
function getDevOpsResponse(question) {
    ...
    return "I can help you with many topics! Here's what I know about:\n\n" +
        "About Usman: 'Who is Usman?', 'skills', 'experience', 'education', 'certifications', 'projects'\n" +
        "Cloud Platforms: 'AWS', 'Azure', 'GCP', 'multi-cloud'\n" +
        "AI/ML: 'RAG', 'AI', 'LangChain'\n" +
        "Containers: 'Docker', 'Kubernetes', 'EKS', 'ECS', 'Helm'\n" +
        "IaC & CI/CD: 'Terraform', 'Ansible', 'Jenkins', 'GitHub Actions', 'pipeline'\n" +
        "Databases: 'RDS', 'DynamoDB'\n" +
        "Serverless: 'Lambda', 'serverless'\n" +
        "Monitoring: 'Prometheus', 'Grafana', 'CloudWatch'\n" +
        "Security: 'DevSecOps'\n" +
        "Other: 'Linux', 'Git', 'microservices', 'load balancer', 'DNS', '12 factor app'\n" +
        "Services: 'services', 'hire', 'contact', 'resume'\n\n" +
        "Try asking any of these topics or say 'hello' to get started!";
}
